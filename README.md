...
<div align="center">
  ...
  <br/>
  <h3><b>The Math Magicians</b></h3>
  <h5>"Math magicians" (a project using React: Components, Events, Fetch data from API, Test &amp; Deploy) is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users to:  Make simple calculations. Read a random math-related quote.<h5>
</div>
...
This project **"Math magicians"** (a project using **React: Components, Events, Fetch data from API, Test &amp; Deploy)** is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users to:  
...
Feel free to check the [issues page](https://github.com/porag-m06/The-Math-Magicians/issues).
